...
// Make Babel:
// - not install the hot re-loader
// - not minify it's output to make exceptions easier to read
...
var relativeMeteorAppPath = 'harness.meteor';
  ...
  return {
    ...
    bootstrap: function () {
      ...
      if (!process.env.ROOT_URL) {
        process.env.ROOT_URL = 'http://localhost:2997/';
      }
